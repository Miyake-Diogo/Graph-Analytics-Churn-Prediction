...
job_json = {
        ...
        "tasks": [
            {
                "job_cluster_key": "graph_churn_cluster",
                "notebook_task": {
                    "notebook_path": f"00_Intro"
                },
                "task_key": "graph_churn_00"
            },
            {
                "job_cluster_key": "graph_churn_cluster",
                "notebook_task": {
                    "notebook_path": f"01_Exploratory_data_analysis"
                },
                "task_key": "graph_churn_01",
                "depends_on": [
                    {
                        "task_key": "graph_churn_00"
                    }
            ...
            },
            {
                "job_cluster_key": "graph_churn_cluster",
                "notebook_task": {
                    "notebook_path": f"02_Customer_feature_engineering"
                },
                "task_key": "graph_churn_02",
                "depends_on": [
                    {
                        "task_key": "graph_churn_01"
                    }
            ...
            },
            {
                "job_cluster_key": "graph_churn_cluster",
                "notebook_task": {
                    "notebook_path": f"03_Graph_feature_engineering"
                },
                "task_key": "graph_churn_03",
                "depends_on": [
                    {
                        "task_key": "graph_churn_02"
                    }
            ...
            },
            {
                "job_cluster_key": "graph_churn_cluster",
                "notebook_task": {
                    "notebook_path": f"04_AutoML_churn_prediction"
                },
                "task_key": "graph_churn_04",
                "depends_on": [
                    {
                        "task_key": "graph_churn_03"
                    }
